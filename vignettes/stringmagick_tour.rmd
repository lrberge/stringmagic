...
If interested, here is the [documentation](LINK_TO_SMAGICK) and next comes an example. 
...
To understand how this works, please have a look at the [dedicated vignette](LINK_TO_SMAGICK).
