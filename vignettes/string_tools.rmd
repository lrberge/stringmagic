...
It has access to all (50+) [`smagick` operations](LINK_TO_SMAGICK_OPS), allowing for
...
1. use `"@op1, op2"` to perform any arbitrary sequence of [`smagick` operation](LINK TO SMAGICK)
