...
knitr::include_graphics("../inst/Operations.png")
```
...
The general syntax for operations that take argument and have option flags is: 
...
knitr::include_graphics("../inst/Operation_details.png")
```
