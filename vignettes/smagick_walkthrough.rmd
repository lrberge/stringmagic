...
If the option `"first"` is provided, the only the first pattern is replaced. That is, 
the function `base::sub` is used instead of `base::gsub`.
```{r}
...
# with option "first"
smagick("{'(?<!\\b)e => a'replace.first ! Where is the letter e?}")
