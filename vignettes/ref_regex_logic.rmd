...
`string_replace`) with the `total` flag (see the [vignette on regex flags](LINK)).
...
All `stringmagic` regexes accept optional flags. Please see the [associated vignette](LINK).
