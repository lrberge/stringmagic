...
- how to [create new string operations](#sec_creation) available within [`string_magic`](LINK)
- how to [use `stringmagic` in a package when employing custom operations](LINK) (this is advanced)
...
The function [`str_clean`](LINK) specialses in cleaning character vectors. To do so it uses a specific syntax
...
The function [`string_vec`](LINK) facilitates the creation of small character vectors.
...
be of concern only when you regularly use [group-wise operations](LINK).
