...
smagic("{'wi/et, le, il, au, des?, ce => _'replace ? le_mont_des_oliviers}")
```
...
several regex patterns. You have more information on this in the [dedicated vignette](LINK).
...
*Technically*, instead of using `gsub` to replace the pattern, [`string_is`](LINK) is used
