...
#' Use the function smagic to interpolate a variable inside a character string and to apply, 
...
#' 
#' To get an overview of the package: [take the tour](https://lrberge.github.io/stringmagic/articles/stringmagic_tour.html). To get started with smagic,
#'  see [the vignette](https://lrberge.github.io/stringmagic/articles/smagic_walkthrough.html).
#' 
